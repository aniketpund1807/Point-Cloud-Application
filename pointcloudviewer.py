...
# # ===========================================================================================================================
    ...
    #     # -----------------------------------------------------------------
    #     # TOP SECTION – Menu / Toolbar (Now at the very top)
    #     # ------------------------------------------------------------------
    #     top_section = QFrame()
    ...
    #     top_title.setStyleSheet("font-weight: bold; font-size: 14px; padding: 10px; border: none;")
    #     top_layout.addWidget(top_title)

    #     # ------------------------------ WORKSHEET BUTTON --------------------------------
    #     self.worksheet_container = QWidget()
    #     self.worksheet_layout = QVBoxLayout(self.worksheet_container)
    #     self.worksheet_layout.setContentsMargins(0, 0, 0, 0)
    #     self.worksheet_layout.setSpacing(2)

    #     self.worksheet_button = QPushButton("📊 Worksheet")      # ← emoji added
    #     self.worksheet_button.setFixedWidth(110)                 # a bit wider for the emoji
    #     self.worksheet_button.setCheckable(True)
    #     self.worksheet_button.clicked.connect(self.toggle_worksheet_options)

    #     self.worksheet_layout.addWidget(self.worksheet_button)

    #     # ... sub-buttons stay the same ...
    #     self.sub_buttons_widget = QWidget()
    #     self.sub_buttons_layout = QHBoxLayout(self.sub_buttons_widget)
    #     self.sub_buttons_layout.setContentsMargins(0, 0, 0, 0)
    #     self.sub_buttons_layout.setSpacing(2)

    #     self.new_worksheet_button = QPushButton("New")
    #     self.new_worksheet_button.setFixedWidth(90)
    #     self.new_worksheet_button.clicked.connect(self.open_new_worksheet_dialog)

    #     self.existing_worksheet_button = QPushButton("Existing")
    #     self.existing_worksheet_button.setFixedWidth(90)

    #     self.sub_buttons_layout.addWidget(self.new_worksheet_button)
    #     self.sub_buttons_layout.addWidget(self.existing_worksheet_button)
    #     self.sub_buttons_widget.setVisible(False)
    #     self.worksheet_layout.addWidget(self.sub_buttons_widget)

    #     top_layout.addWidget(self.worksheet_container)

    #     # ------------------------------ DESIGN BUTTON --------------------------------
    #     self.design_container = QWidget()
    #     self.design_layout = QVBoxLayout(self.design_container)
    #     self.design_layout.setContentsMargins(0, 0, 0, 0)
    #     self.design_layout.setSpacing(2)

    #     self.design_button = QPushButton("📐 Design")            # ← emoji
    #     self.design_button.setFixedWidth(110)
    #     self.design_button.setCheckable(True)
    #     self.design_button.clicked.connect(self.toggle_design_options)
    #     self.design_layout.addWidget(self.design_button)

    #     # sub-buttons unchanged ...
    #     self.sub_design_buttons_widget = QWidget()
    #     self.sub_design_buttons_layout = QHBoxLayout(self.sub_design_buttons_widget)
    #     self.sub_design_buttons_layout.setContentsMargins(0, 0, 0, 0)
    #     self.sub_design_buttons_layout.setSpacing(2)

    #     self.new_design_button = QPushButton("New")
    #     self.new_design_button.setFixedWidth(90)
    #     self.new_design_button.clicked.connect(self.open_create_new_design_layer_dialog)

    #     self.existing_design_button = QPushButton("Existing")
    #     self.existing_design_button.setFixedWidth(90)

    #     self.sub_design_buttons_layout.addWidget(self.new_design_button)
    #     self.sub_design_buttons_layout.addWidget(self.existing_design_button)
    #     self.sub_design_buttons_widget.setVisible(False)
    #     self.design_layout.addWidget(self.sub_design_buttons_widget)

    #     top_layout.addWidget(self.design_container)

    #     # ------------------------------ CONSTRUCTION BUTTON --------------------------------
    #     self.construction_container = QWidget()
    #     self.construction_layout = QVBoxLayout(self.construction_container)
    #     self.construction_layout.setContentsMargins(0, 0, 0, 0)
    #     self.construction_layout.setSpacing(2)

    #     self.construction_button = QPushButton("🏗 Construction")   # ← emoji
    #     self.construction_button.setFixedWidth(130)
    #     self.construction_button.setCheckable(True)
    #     self.construction_button.clicked.connect(self.toggle_construction_options)
    #     self.construction_layout.addWidget(self.construction_button)

    #     # sub-buttons unchanged ...
    #     self.sub_construction_buttons_widget = QWidget()
    #     self.sub_construction_buttons_layout = QHBoxLayout(self.sub_construction_buttons_widget)
    #     self.sub_construction_buttons_layout.setContentsMargins(0, 0, 0, 0)
    #     self.sub_construction_buttons_layout.setSpacing(10)

    #     self.new_construction_button = QPushButton("New")
    #     self.new_construction_button.setFixedWidth(90)
    #     self.new_construction_button.clicked.connect(self.open_material_line_dialog)

    #     self.existing_construction_button = QPushButton("Existing")
    #     self.existing_construction_button.setFixedWidth(90)

    #     self.sub_construction_buttons_layout.addWidget(self.new_construction_button)
    #     self.sub_construction_buttons_layout.addWidget(self.existing_construction_button)
    #     self.sub_construction_buttons_widget.setVisible(False)
    #     self.construction_layout.addWidget(self.sub_construction_buttons_widget)

    #     top_layout.addWidget(self.construction_container)

    #     # ------------------------------ MEASUREMENT BUTTON --------------------------------
    #     self.measurement_container = QWidget()
    #     self.measurement_layout = QVBoxLayout(self.measurement_container)
    #     self.measurement_layout.setContentsMargins(0, 0, 0, 0)
    #     self.measurement_layout.setSpacing(2)

    #     self.measurement_button = QPushButton("📏 Measurement")     # ← emoji
    #     self.measurement_button.setFixedWidth(130)
    #     self.measurement_button.setCheckable(True)
    #     self.measurement_button.clicked.connect(self.toggle_measurement_options)
    #     self.measurement_layout.addWidget(self.measurement_button)

    #     # sub-buttons unchanged ...
    #     self.sub_measurement_buttons_widget = QWidget()
    #     self.sub_measurement_buttons_layout = QHBoxLayout(self.sub_measurement_buttons_widget)
    #     self.sub_measurement_buttons_layout.setContentsMargins(0, 0, 0, 0)
    #     self.sub_measurement_buttons_layout.setSpacing(10)

    #     self.new_measurement_button = QPushButton("New")
    #     self.new_measurement_button.setFixedWidth(90)
    #     self.new_measurement_button.clicked.connect(self.open_measurement_dialog)

    #     self.existing_measurement_button = QPushButton("Existing")
    #     self.existing_measurement_button.setFixedWidth(90)

    #     self.sub_measurement_buttons_layout.addWidget(self.new_measurement_button)
    #     self.sub_measurement_buttons_layout.addWidget(self.existing_measurement_button)
    #     self.sub_measurement_buttons_widget.setVisible(False)
    #     self.measurement_layout.addWidget(self.sub_measurement_buttons_widget)

    #     top_layout.addWidget(self.measurement_container)

    #     # ------------------------------ LAYERS BUTTON --------------------------------
    #     self.layers_button = QPushButton("Layers")  # you didn't ask for an icon here, kept as-is
    #     top_layout.addWidget(self.layers_button)

    #     # ------------------------------ LOAD POINT CLOUD BUTTON --------------------------------
    #     self.load_button = QPushButton("☁ 3D Point Cloud")          # ← emoji
    ...
    #     # ------------------------------ SETTINGS BUTTON --------------------------------
    #     self.setting_button = QPushButton("⚙ Settings")             # ← emoji
    ...
    def initUI(self):
        ...
        # Create checkbox rows (keep all your existing checkbox creation code as is)
        # Zero Line
