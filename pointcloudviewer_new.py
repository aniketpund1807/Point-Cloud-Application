...
from dialogs import ConstructionConfigDialog, CurveDialog, ZeroLineDialog
...
# ===========================================================================================================================
    def initUI(self):
        ...
        self.new_worksheet_button.setStyleSheet("""
            QPushButton {background-color: #FF9800; color: white; border: none; padding: 10px;
        ...
        measurement_frame.setFrameStyle(QFrame.Box | QFrame.Raised)
        measurement_frame.setStyleSheet("QFrame { border: 2px solid #42A5F5; border-radius: 10px; background-color: #E3F2FD; margin: 10px; }")
        measurement_layout = QVBoxLayout(measurement_frame)
        measurement_title = QLabel("Measurement Section")
        measurement_title.setAlignment(Qt.AlignCenter)
        measurement_title.setStyleSheet("font-weight: bold; font-size: 13px; padding: 8px; background-color: #E3F2FD; border-radius: 5px;")
        ...
        measurement_layout.addWidget(self.measurement)
        #-------------------------------------------------------------
        ...
        measurement_layout.addWidget(self.metrics_group)
        #-------------------------------------------------------------
        ...
        measurement_layout.addWidget(self.line_button)
        self.presized_button = QPushButton("Presized")
        self.presized_button.setVisible(False) # Start hidde
        measurement_layout.addWidget(self.presized_button)
        ...
        measurement_layout.addWidget(self.polygon_button)
        # NEW: Stockpile Polygon button
        self.stockpile_polygon_button = QPushButton("Stockpile Polygon")
        self.stockpile_polygon_button.setVisible(False)
        measurement_layout.addWidget(self.stockpile_polygon_button)
        ...
        measurement_layout.addWidget(self.complete_polygon_button) # Add complete button
        left_layout.addWidget(measurement_frame)
        # ----------------------------------------------------------------------------
        # Road Configuration Section
        # ----------------------------------------------------------------------------
        road_config_frame = QFrame()
        road_config_frame.setFrameStyle(QFrame.Box | QFrame.Raised)
        road_config_frame.setStyleSheet("QFrame { border: 2px solid #42A5F5; border-radius: 10px; background-color: #E3F2FD; margin: 10px; }")
        road_layout = QVBoxLayout(road_config_frame)
        road_title = QLabel("Road and Bridge Configuration")
        road_title.setAlignment(Qt.AlignCenter)
        road_title.setStyleSheet("font-weight: bold; font-size: 13px; padding: 8px; background-color: #E3F2FD; border-radius: 5px;")
        ...
        road_layout.addWidget(self.road_baseline)
        road_layout.addWidget(self.bridge_baseline)
        # Road Surface combo
        road_row = QHBoxLayout()
        road_label = QLabel("Select Road Surface:")
        road_label.setStyleSheet("padding: 5px; font-size: 12px;")
        road_row.addWidget(road_label)
        self.road_combo = QComboBox()
        self.road_combo.addItems(["Sub Grade", "Sub Base", "Base Course", "Asphalt Layer", "Concrete Layer"])
        self.road_combo.setStyleSheet("padding: 5px; border: 1px solid #ccc; border-radius: 3px; background-color: white;")
        #self.road_combo.currentTextChanged.connect(self.road_selected)
        road_row.addWidget(self.road_combo)
        road_layout.addLayout(road_row)
        # Bridge combo
        bridge_row = QHBoxLayout()
        bridge_label = QLabel("Select Bridge Components:")
        bridge_label.setStyleSheet("padding: 5px; font-size: 12px;")
        bridge_row.addWidget(bridge_label)
        self.bridge_combo = QComboBox()
        self.bridge_combo.addItems(["Bridge Abutment", "Bridge Deck", "Bridge Pier", "Bridge Girder"])
        self.bridge_combo.setStyleSheet("padding: 5px; border: 1px solid #ccc; border-radius: 3px; background-color: white;")
        #self.bridge_combo.currentTextChanged.connect(self.bridge_selected)
        bridge_row.addWidget(self.bridge_combo)
        road_layout.addLayout(bridge_row)
        left_layout.addWidget(road_config_frame)
...
# -------------------------------------------------------------------------------------------------------------
    ...
    def toggle_measurement_buttons(self):
        visible = self.line_button.isVisible()
        #self.start_measurement_button.setVisible(not visible)
        self.line_button.setVisible(not visible)
        self.presized_button.setVisible(not visible)
        self.polygon_button.setVisible(not visible)
        self.stockpile_polygon_button.setVisible(not visible)
        self.measurement.setText("Hide Measurements" if not visible else "Measurement")
